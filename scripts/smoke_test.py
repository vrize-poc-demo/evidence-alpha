...
def main() -> None:
    ...
    for case in SAMPLE_CASES:
        ...
        assert_ok(answer["status"] in {"answered", "not_found"}, f"{case['doc_name']} sample should return a valid status")
    ...
    assert_ok(all_filing_answer["status"] in {"answered", "not_found"}, "all-filing search should return a valid status")
    assert_ok(all_filing_answer["evidence"], "all-filing search should return evidence")
